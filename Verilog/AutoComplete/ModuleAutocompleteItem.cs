...
namespace pluginVerilog.Verilog.AutoComplete
{
    public class ModuleAutocompleteItem : codeEditor.CodeEditor.AutocompleteItem
    {
        ...
        public ModuleAutocompleteItem(string text, byte colorIndex, Color color, IconImage icon, IconImage.ColorStyle iconColorStyle) : base(text, colorIndex, color, icon, iconColorStyle)
        {
        }
