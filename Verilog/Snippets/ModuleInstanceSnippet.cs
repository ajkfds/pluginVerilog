...
namespace pluginVerilog.Verilog.Snippets
{
    public class ModuleInstanceSnippet : codeEditor.Snippets.InteractiveSnippet
    {
        ...
        // initial value for {n}
        private List<string> initials = new List<string> { "module_name", "instance_name", "();"  };
        ...
        public override void Apply(CodeDocument codeDocument)
        {
            ...
            codeEditor.Controller.CodeEditor.ForceOpenAutoComplete(new List<AutocompleteItem>
                        {
                            new AutocompleteItem("MODULE1",(byte)CodeDrawStyle.ColorType.Keyword ,Color.Red),
                            new AutocompleteItem("MODULE2",(byte)CodeDrawStyle.ColorType.Keyword ,Color.Red),
                        });
        }
            ...
            if (e.Handled) // closed
            {
                ...
                switch (i)
                {
                    ...
                    case 1: // instance name
                        int start, last;
                        codeEditor.Controller.CodeEditor.GetHighlightPosition(0, out start, out last);
